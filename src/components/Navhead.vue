	...
	<header class="header">
	    ...
	    <div class="navbar">
	        ...
	        <div class="navbar-menu-container">
	            ...
	            <span class="navbar-link"   v-if="loginStatus">{{loginName}}</span>
	            <a href="javascript:void(0)" @click="loginModalFlag=true" class="navbar-link" v-if="!loginStatus">Login</a>
	            <a href="javascript:void(0)" class="navbar-link" @click="loginout" v-if="loginStatus">Logout</a>
          ...
          <div class="md-modal-inner">
            ...
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap" v-if="loginModalFlag">
...
<script>
    ...
    export default{
        ...
        methods:{
        	...
        	loginout(){
        		axios.post('http://127.0.0.1:3000/users/loginout').then((response)=>{
        			let res = response.data;
        			if(res.status=="0"){
          ...
          checklogin(){
            axios.post('http://127.0.0.1:3000/users/checklogin').then((response)=>{
              let res = response.data;
              if(res.status=="0"){
                  this.loginModalFlag = false;
                  this.loginStatus=true;
