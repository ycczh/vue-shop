  ...
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressLIstFilter" :class="{'check':checkedIndex==index}" @click="checkedIndex=index">
                  <dl>
                    <dt>{{item.userName}}</dt>
                    <dd class="address">{{item.addressName}}</dd>
                    <dd class="tel">{{item.telphone}}</dd>
                  </dl>
    ...
    <modal :md-show="delModalShow" @close="closeModalShow">
          ...
          <div slot="btnGroup">
              ...
              <a class="btn btn--m btn--red" href="javascript:;" @click="deladdress">确定</a>
          </div>
...
<script>
    ...
    export default{
      ...
      methods:{
        init:function(){
          axios.post('http://127.0.0.1:3000/users/getAddressList').then((response)=>{
        ...
        setDefault(addressId){
            axios.post("http://127.0.0.1:3000/users/addressDefault",{addressId:addressId}).then((response)=>{
        ...
        deladdress(){
            axios.post('http://127.0.0.1:3000/users/delAddress',{
